  ...
  return (
    <div className='w-full mt-3 p-2 shadow-xl bg-slate-50'>
      <div className='w-full flex justify-between border-b border-gray-600'>
        ...
        <div onClick={handleOpenForm}><BiPencil/></div>
      </div>
          ...
          <div className='flex flex-col w-full'>
            <div className='flex flex-row w-full'>
              <div className='flex flex-col w-1/2'>
                ...
                <select name="designation" id="designation" onChange={handleChange} value={formData.designation}>
                  <option value="-">-</option>
              ...
              <div className='flex flex-col w-1/2'>
                ...
                <input type="text" id="jobTitle" name="jobTitle" placeholder='Job Title' className="w-full" onChange={handleChange} value={formData.jobTitle} />
              </div>
            </div>
            <div className='flex flex-row w-full'>
              <div className='flex flex-col w-1/2'>
            ...
            <div className="flex justify-end mt-4">
              <div className="bg-white flex gap-1 flex-row items-center justify-center rounded p-2 hover:scale-105 border border-gray-300" onClick={handleOpenForm }>
